      ...
      child: Stack(
        ...
        children: [
          Container(
            ...
            child: SvgPicture.string(widget.svgSrc),
          ),
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(
                    "${widget.numOfitem}",
                    style:
                    const TextStyle(fontSize: 12, height: 1, fontWeight:
    ...
    return Container(
      ...
      child: const Text.rich(
        TextSpan(
          ...
          children: [
            TextSpan(text: "Bienvenue dans votre\n"),
            TextSpan(
              text: "Application de gestion immobiliere ",
              style: TextStyle(
                fontSize: 19,
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              return ProductCard(
                ...
                onPress: () {
                  switch (demoProducts[index].id) {
                    case 1:
                      Navigator.pushNamed(context, Routes.proprieteRoute);
                      break;
                    case 2:
                      Navigator.pushNamed(context, Routes.locataireRoute);
                      break;
                    case 3:
                      Navigator.pushNamed(context, Routes.proprieteRoute);
                      break;
...
List<Product> demoProducts = [
  Product(
    id: 1,
    images: ["https://i.postimg.cc/DznGd4Cr/one.png"],
    colors: [
  ...
  Product(
    id: 2,
    images: [
      "https://i.postimg.cc/3RwDz5QW/two.png",
    ],
    colors: [
      const Color(0xFFF6625E),
      const Color(0xFF836DB8),
  ...
  Product(
    id: 3,
    images: [
      "https://i.postimg.cc/N0DHNGVW/three.png",
    ],
    colors: [
      const Color(0xFFF6625E),
      const Color(0xFF836DB8),
