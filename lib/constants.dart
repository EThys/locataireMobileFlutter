...
final passwordValidator = MultiValidator([
  RequiredValidator(errorText: 'Le mot de passe est réquis'),
  MinLengthValidator(8, errorText: 'Le mot de passe doit comporter au moins 8 chiffres'),
  PatternValidator(r'(?=.*?[#?!@$%^&*-])',
      errorText: 'Les mot de passe doit avoir au moins un caractère spécial')
]);

final emaildValidator = MultiValidator([
  RequiredValidator(errorText: "L'adresse mail est réquis "),
  EmailValidator(errorText: "Entrer un email valide"),
]);
